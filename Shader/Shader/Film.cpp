#include "Film.h"
Film::Film(int xres, int yres, const char * filename_, ColorRGB backgroundColor_ = ColorRGB{ 0, 0, 0 }) :xResolution(xres), yResolution(yres), filename(filename_), backgroundColor(backgroundColor_)
{
